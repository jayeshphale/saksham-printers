...
import { FaEnvelope, FaPhone, FaLock, FaStar, FaShippingFast, FaPrint } from 'react-icons/fa';
        ...
        <div className="grid md:grid-cols-4 gap-12 border-b border-white/10 pb-16 mb-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <FaPrint className="w-10 h-10 text-primary-500" />
              <span className="text-3xl font-black tracking-tight">Saksham Printers</span>
            </div>
